...
using PracticeMVC3.Models;

namespace PracticeMVC3.Controllers
{
    public class VirtualPetsController : Controller
    {
        private PracticeMVC3Context db = new PracticeMVC3Context();
        ...
        public ActionResult Create([Bind(Include = "virtualPetID,Name,Age,Hunger,Type,Thirst")] VirtualPet virtualPet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "virtualPetID,Name,Age,Hunger,Type,Thirst")] VirtualPet virtualPet)
        {
            if (ModelState.IsValid)
            {
